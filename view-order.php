        ...
        <div class="col-md-12">
          ...
          <table class="cart-table account-table table table-bordered">
            ...
            <tbody>
              ...
              $orditmsql = "SELECT * FROM orderitems o
              JOIN products p WHERE o.orderid='$oid' AND o.pid=p.id";
          ...
          <div class="ma-address">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <?php
                $csql = "SELECT u1.firstname, u1.lastname , u1.address1 , u1.address2 ,
                 u1.city , u1.state , u1.country ,u1.company , u.email , u1.mobile ,
                u1.zip FROM users u JOIN usersmeta u1 WHERE u.id=u1.uid AND u.id=$uid";
